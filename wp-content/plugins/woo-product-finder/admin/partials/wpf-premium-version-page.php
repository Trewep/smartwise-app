...
<div id="main-tab">
    <div class="wrapper">
        <div class="tab-dot">
            <div class="wpf-main-table res-cl key-featured">
                ...
                <table class="table-outer premium-free-table" align="center">
                    ...
                    <tbody>
                        <tr class="dark">
                            ...
                            <td><img src="<?php echo esc_url(WPF_PLUGIN_URL) . 'admin/images/check-mark.png'; ?>"></td>
                            <td><img src="<?php echo esc_url(WPF_PLUGIN_URL) . 'admin/images/check-mark.png'; ?>"></td>
                        </tr>
                        <tr>
                        ...
                        <tr class="dark">
                            ...
                            <td><img src="<?php echo esc_url(WPF_PLUGIN_URL) . 'admin/images/trash.png'; ?>"></td>
                            <td><img src="<?php echo esc_url(WPF_PLUGIN_URL) . 'admin/images/check-mark.png'; ?>"></td>
                        </tr>
                        <tr>
                        ...
                        <tr class="pad radius-s">
                            <td class="pad"></td>
                            <td></td>
                            <td class="green red"><a href="<?php echo esc_url(WPF_EXPETRANL_URL); ?>" target="_blank"><?php esc_html_e('UPGRADE TO'); ?> <br> <?php esc_html_e('PREMIUM VERSION'); ?> </a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
