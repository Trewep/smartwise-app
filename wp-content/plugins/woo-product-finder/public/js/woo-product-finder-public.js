(function($) {
    ...
    $(window).load(function() {
        ...
        jQuery(".wpf-button-previous").hide();
        jQuery(".wpf-button-previous").hide();
        jQuery(".wpf-display-results-button").hide();
        jQuery(".wpf-start-advisor-button").hide();
        jQuery(".wpf-scroll-to-results-button").hide();

        jQuery('body').on('click', '.wpf-button-next', function(e) {
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    jQuery('#wpf_question_list_new_' + wizard_int_id).html(response.next_html);
        ...
        jQuery('body').on('click', '.wpf-button-previous', function(e) {
            var main_id = jQuery(this).attr('id');
            var parts = main_id.split('_');
            var wizard_int_id = parts[1];
            var question_int_id = parts[3];
            ...
            jQuery.ajax({
                ...
                dataType: 'json',
                success: function(response) {
                    jQuery('#wpf_question_list_new_' + wizard_int_id).html(response.previous_html);
                    var total_selected_value = []
                    var current_selected_value_arr = [];
                    var total_question_id = response.question_id_array;
                    jQuery.each(total_question_id, function(i, val) {
        ...
        jQuery('body').on('click', 'span.wpf-answer-selector input.wpf-input', function(e) {
            ...
            var allInputs = jQuery("input.wpf-input:input");
            ...
            if (allInputs_type == 'radio') {
                var radioValue = jQuery("input.wpf-input:radio:checked").val();
                if (radioValue) {
                ...
                success: function(response) {
                    ...
                    jQuery.each(split_val, function(i, val) {
                        ...
                        jQuery('.prd_section .prd-attribute').each(function() {
                            ...
                            console.log('prd_attribute_class ' + prd_attribute_class);
